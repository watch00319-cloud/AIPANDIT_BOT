...
async def q1(msg: Message, state: FSMContext):
    ...
    await msg.answer("Q2/5: Vivah ya relationship ko lekar aap kya guidance chahte hain?")
...
async def q3(msg: Message, state: FSMContext):
    ...
    await msg.answer("Q4/5: Finance ya wealth growth me abhi sabse bada concern kya hai?")
...
async def q5(msg: Message, state: FSMContext):
    ...
    await msg.answer(
        ...
        "Ab aap apni premium service select kar sakte hain."
    )
